...
#mes 1
mes1 <- "./Rohdaten_MIV/13052020_MIV/B290pgj - @109@ - Rohdaten - Kilchberg (ZH0109), Seestrasse (Route Nr.xlsx"
...
#mes 2
# mes2 <-  "./Rohdaten_MIV/13052020_MIV/B290pgj - @587@ - Rohdaten - Uster (ZH0587), Riedikerstrasse (Route Nr.xlsx"
...
#mes 3
mes3 <-  "./Rohdaten_MIV/13052020_MIV/B290pgj - @609@ - Rohdaten - Zürich (ZH0609), Birmensdorferstrasse (Route Nr.xlsx"
...
#mes 4
mes4 <-  "./Rohdaten_MIV/13052020_MIV/B290pgj - @5191@ - Rohdaten - Dübendorf (ZH5191), Zürichstrasse (Route Nr.xlsx"
...
mes5 <-  "./Rohdaten_MIV/13052020_MIV/B290pgj - @5186@ - Rohdaten - Uster (ZH5186), Oberland-Autobahn (A53).xlsx"
...
#mes 6
mes6 <-  "./Rohdaten_MIV/13052020_MIV/B290pgj - @4790@ - Rohdaten - Horgen (ZH4790), Zugerstrasse (Route Nr.xlsx"
...
# mes7 <-  "./Rohdaten_MIV/13052020_MIV/B290pgj - @3690@ - Rohdaten - Thalwil (ZH3690), Zürcherstrasse (Route Nr.xlsx"
...
#mes 8
mes8 <-  "./Rohdaten_MIV/13052020_MIV/B290pgj - @3687@ - Rohdaten - Birmensdorf (ZH3687), Aargauerstrasse (Route Nr.xlsx"
...
#mes 9
mes9 <-  "./Rohdaten_MIV/13052020_MIV/B290pgj - @2287@ - Rohdaten - Horgen (ZH2287), Zugerstrasse (Route Nr.xlsx"
...
#mes 10
mes10 <-  "./Rohdaten_MIV/13052020_MIV/B290pgj - @2085@ - Rohdaten - Regensdorf (ZH2085), Wehntalerstrasse (Route Nr.xlsx"
...
#mes 11
mes11 <-  "./Rohdaten_MIV/13052020_MIV/B290pgj - @208@ - Rohdaten - Obfelden (ZH0208), Dorfstrasse (Route Nr.xlsx"
...
#mes 12
mes12 <-  "./Rohdaten_MIV/13052020_MIV/B290pgj - @1887@ - Rohdaten - Langnau am Albis (ZH1887), Albisstrasse (Route Nr.xlsx"
...
#mes 13
mes13 <-  "./Rohdaten_MIV/13052020_MIV/B290pgj - @1288@ - Rohdaten - Zollikon (ZH1288), Forchstrasse (Route Nr.xlsx"
...
#mes 14
mes14 <-  "./Rohdaten_MIV/13052020_MIV/B290pgj - @1109@ - Rohdaten - Knonau (ZH1109), Zürichstrasse (Route Nr.xlsx"
...
mes15 <-  "./Rohdaten_MIV/13052020_MIV/B290pgj - @110@ - Rohdaten - Winkel (ZH0110), Autobahn (A51).xlsx"
