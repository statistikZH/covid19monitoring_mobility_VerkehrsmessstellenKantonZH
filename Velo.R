...
#mes 16
mes16 <- "./Rohdaten_Velo/15042020_Velo/B290pgj - @1018@ - Rohdaten - Dietikon (ZH1018), Radweg (1018_Dietikon).xlsx"
...
#mes 17
mes17 <-  "./Rohdaten_Velo/15042020_Velo/B290pgj - @2019@ - Rohdaten - Hausen am Albis (ZH2019), Radweg, (2019_Hausen am Albis).xlsx"
...
#mes 18
mes18 <-  "./Rohdaten_Velo/15042020_Velo/B290pgj - @316@ - Rohdaten - Greifensee (ZH0316), Radweg (316_Greifensee).xlsx"
...
#mes 19
mes19 <-  "./Rohdaten_Velo/15042020_Velo/B290pgj - @716@ - Rohdaten - Regensdorf (ZH0716), Radweg, (716_Regensdorf).xlsx"
