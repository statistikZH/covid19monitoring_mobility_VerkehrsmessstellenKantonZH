---
title: "covid19monitoring_mobility_BD"
...
R1_tageswert_messstelle <- richtung1 %>%
  transmute('date' = richtung1$date,
            ...
            'update' := "t\u00e4glich",
            'public' := "ja",
            'description' := "https://github.com/statistikZH/covid19_mobility_ZaehlstellenMIVVeloKantonZH") %>%
  drop_na()
...
write.table(tageswerte_messstelle, "./Mobility_BD_3687.csv", sep=",", fileEncoding="UTF-8", row.names = F)
...
write.table(tageswerte_messstelle_velo, "./Mobility_BD_1018.csv", sep=",", fileEncoding="UTF-8", row.names = F)
...
miv1 <- read_csv("C:/gitrepos/covid19monitoring_mobility_BD/Mobility_BD_109.csv")
  
miv2 <- read_csv("C:/gitrepos/covid19monitoring_mobility_BD/Mobility_BD_1109.csv")
  
miv3 <- read_csv("C:/gitrepos/covid19monitoring_mobility_BD/Mobility_BD_1288.csv")
  
miv4 <- read_csv("C:/gitrepos/covid19monitoring_mobility_BD/Mobility_BD_1887.csv")
  
miv5 <- read_csv("C:/gitrepos/covid19monitoring_mobility_BD/Mobility_BD_208.csv")
  
miv6 <- read_csv("C:/gitrepos/covid19monitoring_mobility_BD/Mobility_BD_2287.csv")
  
miv7 <- read_csv("C:/gitrepos/covid19monitoring_mobility_BD/Mobility_BD_3690.csv")
  
miv8 <- read_csv("C:/gitrepos/covid19monitoring_mobility_BD/Mobility_BD_4790.csv")
  
miv9 <- read_csv("C:/gitrepos/covid19monitoring_mobility_BD/Mobility_BD_5191.csv")
  
miv10 <- read_csv("C:/gitrepos/covid19monitoring_mobility_BD/Mobility_BD_587.csv")
  
miv11 <- read_csv("C:/gitrepos/covid19monitoring_mobility_BD/Mobility_BD_609.csv")

miv12 <- read_csv("C:/gitrepos/covid19monitoring_mobility_BD/Mobility_BD_110.csv")

miv13 <- read_csv("C:/gitrepos/covid19monitoring_mobility_BD/Mobility_BD_5186.csv")

miv14 <- read_csv("C:/gitrepos/covid19monitoring_mobility_BD/Mobility_BD_2085.csv")
  
miv15 <- read_csv("C:/gitrepos/covid19monitoring_mobility_BD/Mobility_BD_3687.csv")

velo1 <- read_csv("C:/gitrepos/covid19monitoring_mobility_BD/Mobility_BD_1018.csv")
  
velo2 <- read_csv("C:/gitrepos/covid19monitoring_mobility_BD/Mobility_BD_2019.csv")
  
velo3 <- read_csv("C:/gitrepos/covid19monitoring_mobility_BD/Mobility_BD_316.csv")
  
velo4 <- read_csv("C:/gitrepos/covid19monitoring_mobility_BD/Mobility_BD_716.csv")
...
write.table(mobility_bd, "./Mobility_BD.csv", sep=",", fileEncoding="UTF-8", row.names = F)
